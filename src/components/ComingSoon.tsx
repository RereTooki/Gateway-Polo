    ...
    <>
      <div className="sborder-4 border-black pt-16 flex flex-col items-center px-4 gap-6 text-greens">
        <div className="sborder-4 bg-greens w-full px-8 py-12 text-white flex flex-col items-center justify-center gap-6">
          ...
          <div className="sborder-2 flex flex-row items-center gap-6 text-center w-full">
          ...
          <div className="sborder-2 flex flex-row items-center gap-6 text-center w-full">
            ...
            <div className=" w-full h-[50px]">
              <button className="text-black bg-white p-2 w-full  rounded-lg text-xs transition ease-in-out duration-500 delay-10 cursor-pointer hover:scale-[1.04] flex items-center justify-evenly ">
